**Table of Contents**
- [1. Setup SSH Serve to Login Ubuntu](#1-setup-ssh-serve-to-login-ubuntu)
...
# 1. Setup SSH Serve to Login Ubuntu
...
You should see the output: `Active: active (runming)`
```bash
# Output
#
...
Type `yse` and will prompt to enter password to login
```bash
# Output
# 
